...
const BINANCE_SYMBOLS = [
  ...
  { symbol: 'SHIBUSDT', name: 'Shiba Inu', pair: 'SHIB/USDT' },
  ...
  { symbol: 'RNDRUSDT', name: 'Render', pair: 'RNDR/USDT' },
  { symbol: 'VETUSDT', name: 'VeChain', pair: 'VET/USDT' },
  { symbol: 'HBARUSDT', name: 'Hedera', pair: 'HBAR/USDT' },
  { symbol: 'LDOUSDT', name: 'Lido DAO', pair: 'LDO/USDT' },
  { symbol: 'OPUSDT', name: 'Optimism', pair: 'OP/USDT' },
  { symbol: 'GRTUSDT', name: 'The Graph', pair: 'GRT/USDT' },
  { symbol: 'INJUSDT', name: 'Injective', pair: 'INJ/USDT' },
  { symbol: 'RUNEUSDT', name: 'THORChain', pair: 'RUNE/USDT' },
  { symbol: 'THETAUSDT', name: 'Theta Network', pair: 'THETA/USDT' },
  { symbol: 'FTMUSDT', name: 'Fantom', pair: 'FTM/USDT' },
  { symbol: 'ALGOUSDT', name: 'Algorand', pair: 'ALGO/USDT' },
  { symbol: 'FLOWUSDT', name: 'Flow', pair: 'FLOW/USDT' },
  { symbol: 'TIAUSDT', name: 'Celestia', pair: 'TIA/USDT' },
  { symbol: 'SNXUSDT', name: 'Synthetix', pair: 'SNX/USDT' },
  { symbol: 'MANAUSDT', name: 'Decentraland', pair: 'MANA/USDT' },
  { symbol: 'SANDUSDT', name: 'The Sandbox', pair: 'SAND/USDT' },
  { symbol: 'AXSUSDT', name: 'Axie Infinity', pair: 'AXS/USDT' },
  { symbol: 'AAVEUSDT', name: 'Aave', pair: 'AAVE/USDT' },
  { symbol: 'QNTUSDT', name: 'Quant', pair: 'QNT/USDT' },
  { symbol: 'EGLDUSDT', name: 'MultiversX', pair: 'EGLD/USDT' },
  { symbol: 'SEIUSDT', name: 'Sei', pair: 'SEI/USDT' },
  { symbol: 'SUIUSDT', name: 'Sui', pair: 'SUI/USDT' },
  { symbol: 'STXUSDT', name: 'Stacks', pair: 'STX/USDT' },
  { symbol: 'NEOUSDT', name: 'Neo', pair: 'NEO/USDT' },
  { symbol: 'EOSUSDT', name: 'EOS', pair: 'EOS/USDT' },
  { symbol: 'XTZUSDT', name: 'Tezos', pair: 'XTZ/USDT' },
  { symbol: 'WLDUSDT', name: 'Worldcoin', pair: 'WLD/USDT' },
  { symbol: 'PEPEUSDT', name: 'Pepe', pair: 'PEPE/USDT' }
];
